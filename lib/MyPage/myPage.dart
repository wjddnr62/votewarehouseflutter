                            ...
                            child: Container(
                              ...
                              child: RaisedButton(
                                onPressed: () {
                                  ...
                                  provider.withdrawalUser(dataSave.email).then((value) {
                                    if (value == 1) {
                                      setState(() {
                                        loading = false;
                                      });
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Text("필수정보", style: TextStyle(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => RequiredInfomation()));
                      },
                      child: Image.asset("assets/icon/modify_grey.png", width: 24, height: 24,),
                    )
                  ],
                ),
              ),
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        Container(
                          width: 53,
                          child: Text("거주 지역", style: TextStyle(
                            fontSize: 13, color: Color(0xFFBBBBBB)
                          ),),
                        ),
                        whiteSpaceW(33),
                        Text(dataSave.user.address, style: TextStyle(
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        whiteSpaceW(33),
                        Text(dataSave.user.age, style: TextStyle(
                            color: Color(0xFF666666), fontSize: 14
                        ),)
                      ],
                    ),
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        whiteSpaceW(33),
                        Text(dataSave.user.gender, style: TextStyle(
                            color: Color(0xFF666666), fontSize: 14
                        ),)
                      ],
                    )
                ...
                child: RaisedButton(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Image.asset("assets/icon/modify_grey.png", width: 24, height: 24,)
                    ],
                  ),
                ),
              ),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("회원탈퇴", style: TextStyle(
                            fontSize: 14, color: Color(0xFFBBBBBB), decoration: TextDecoration.underline
                        ),),
                      ),
                    ),
                  ),
