...
class AuthFindPasswordChange extends StatefulWidget {
  String email;

  AuthFindPasswordChange({Key key, this.email}) : super(key: key);

  @override
  _AuthFindPasswordChange createState() => _AuthFindPasswordChange();
}

class _AuthFindPasswordChange extends State<AuthFindPasswordChange>
  ...
  String changeText = "새 비밀번호를 입력해주세요.";
  int type = 0;
                            ...
                            child: Container(
                              ...
                              child: RaisedButton(
                                onPressed: () {
                                  provider
                                      .authFindPassChange(
                                          newPassController.text, widget.email)
                                      .then((value) {
                                    if (value == 1) {
                                      Navigator.of(context, rootNavigator: true)
                                          .pop();
